...
Cost: <><> 
Hit Roll: 1d20+1
Dagger Damage: 1d4+2+4 (s/p)
Spear Damage: 1d8+1 (p)
Rapid Crit - Dagger
Cost: <> 
Hit Roll: 1d20+1+4
Damage 1d4+2+4 (p/s)
...
Cost: <><> 
Hit Roll: 1d20+1
Damage: 1d8+1 (p) +2 against targets that have just finished a charge 
### Roll Checks 
**For:** +1 
**Ref:** +6 
**Wil:** +2 
...
**Rapid Crit** - *(Dagger Signature Strike)* 
AP cost <> 
*Requirements: Wielding a Dagger*
Make a strike against a target you are engaged with, on scoring a Crit hit perform 1 free version of this strike.
**Braced Thrust** - *(Spear Signature Strike)* 
AP cost <><> 
*Requirements: Wielding a Spear* 
You make a thrust at a target that has just finished a charge gain an additional +2 core damage. 
**Wounding strike** 
AP cost <><> 
*Requirements: 1 flair points* 
roll hit then target performs a fort check on the hit
Deal no damage instead roll wound for chosen damage type
**Pocket Sand** 
AP cost <> 
*Requirements: 2 flair points* 
You throw sand into the eyes of an engaged target apply blinded for 1 turn
**Risky Blow** 
AP cost >< 
*Requirements: 7 flair points & target has missed a melee attack against you* 
Make a strike on that target with a +2 to hit. on a failed attack the targets attack counts as a hit.
**Sneak attack-small** 
AP cost <> 
*Requirements: 4 flair points, target is flatfooted, attack must be made with a small weapon* 
make a weapon strike adding base weapon damage +1d4 core
...
Spear
Grand Dagger
bandolier with quick release pouch