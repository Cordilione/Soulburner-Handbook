...
**Fallow Though**
	 AP cost ><
	 *Requirements: Wielding an Agile Weapon*
	 On successfully landing a Strike you can spend your reaction and end your turn by making another strike on the same target.

**Raise Weapon**
	 AP cost <>
	 *Requirements: Wielding an Medium or Large Weapon*
	 You ready your weapon in a defensive stance proving a +1 to ac with medium weapons and +2 with large weapons.

**Quick Step**
	AP cost ><
	*Requirements: Wearing wither light or no armor*
	On an enemies failed attack on you you can perform a 10ft stride that disengages you for nearby targets.
...
---
**Therian Shifting**
Thanks to your race your form is highly fluid as a Therian. From face shape and hair color to pushing the extremes of your form you hold the ability to shift your flesh and pigments at will. The only true limits to your ability is that nothing in your body can be removed or added to make a form and bone cannot be reshaped. This action requires time often a full day for total face conversions. Minor shifts like that of pigments can be done near instantly however.
...
Made on first pass of Character
	Fighter/Swashbuckler with faith pack. She fights far more like a swashbuckler with a DEX focus and a more fluid almost defensive fighting however she does not use a "Pannus" or finishers as a swashbuckler would. In addition she welcomes a metal plate when addable for armor instead of relaying on evasion. 
	A faith pack or personal bond with a deity its unclear at the moment if this is to be a class or background but it is a core aspect of this character that must be thought through when going back to dev. 
	Therian keep the Cosmetic control possible add to it give it more than a social impact (adding rules abilities or systems that reflect the bio control they have)

Abandoned Idea 1
	Gonna leave the long cape accessory behind. largely because of difficult in balancing the flatfoot action and reflection on the if the effect is needed. may return to it later currently unsure. 